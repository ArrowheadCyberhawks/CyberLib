...
public class XboxControllerWrapper extends CommandXboxController {
	...
	public double getLeftMagnitude() {
		return interpolate(MathUtil.applyDeadband(Math.sqrt(super.getLeftX() * super.getLeftX() + super.getLeftY() * super.getLeftY()), kDeadband));
	}
	...
	public double getLeftY() {
		...
		return Math.sin(getLeftAngle()) * getLeftMagnitude();
	}
	...
	public double getLeftX() {
		...
		return Math.cos(getLeftAngle()) * getLeftMagnitude();
	}
